# ============================================================== #
#   DAN MURPHY'S LIQUOR SALES — COMPLETE R ANALYSIS              #
#   Platform  : Databricks (SparkR / R Notebook)                 #
#   Techniques: EDA · Data Storytelling · ANOVA · Hypothesis     #
#               Testing · Regression · Visualisations            #
# ============================================================== #
...
# ──────────────────────────────────────────────────────────────
# Run this cell once; restart cluster if prompted
...
required_packages <- c(
  ...
  "dunn.test",    # Dunn post-hoc test
  "corrplot",     # correlation matrix plots
  "knitr",        # neat table display
...
# Option A — reading directly from DBFS (Databricks File System)
# Upload the CSV to DBFS first via the Data tab, then use:
# df_raw <- read.csv("/dbfs/FileStore/tables/liquor_sales_2000_rows.csv",
#                    stringsAsFactors = FALSE, na.strings = c("", "NA"))

# Option B — local / repo path (used here for portability)
df_raw <- read.csv(
  "Intro_to_Databricks_-_liquor_sales_2000_rows.csv",
...
knitr::kable(missing_report, caption = "📊 Missing Value Report — Raw Dataset")


# ──────────────────────────────────────────────────────────────
# CELL 5 — DESCRIPTIVE STATISTICS (DATA STORYTELLING INTRO)
# ──────────────────────────────────────────────────────────────

cat("
╔══════════════════════════════════════════════════════════╗
║        DAN MURPHY'S LIQUOR SALES — STORY SNAPSHOT       ║
╚══════════════════════════════════════════════════════════╝
")
...
# ──────────────────────────────────────────────────────────────
# CELL 6 — EDA: DISTRIBUTION OF TOTAL SALES (with storytelling)
# ──────────────────────────────────────────────────────────────
...
# 6a — Histogram of Total Sale Value
...
# 6b — Log-scale to reveal the tail
...
cat(sprintf("\n📐 Skewness of Total Sales : %.2f (positive = right-skewed)\n",
            skewness(df$total)))
cat(sprintf("📐 Kurtosis of Total Sales : %.2f (>3 = heavy tails)\n",
            kurtosis(df$total)))


# ──────────────────────────────────────────────────────────────
# CELL 7 — EDA: REVENUE BY SPIRIT TYPE (Storytelling)
# ──────────────────────────────────────────────────────────────
...
# ──────────────────────────────────────────────────────────────
# CELL 8 — EDA: MONTHLY SALES TREND (Time-Series Storytelling)
# ──────────────────────────────────────────────────────────────
...
# ──────────────────────────────────────────────────────────────
# CELL 9 — EDA: TOP 10 COUNTIES BY REVENUE
# ──────────────────────────────────────────────────────────────
...
# ──────────────────────────────────────────────────────────────
# CELL 11 — EDA: PREMIUM vs STANDARD COMPARISON
# ──────────────────────────────────────────────────────────────
...
# ──────────────────────────────────────────────────────────────
# CELL 12 — EDA: CORRELATION MATRIX
# ──────────────────────────────────────────────────────────────
...
# ──────────────────────────────────────────────────────────────
# CELL 14 — EDA: SEASONAL / QUARTERLY PATTERNS
# ──────────────────────────────────────────────────────────────
...
# ──────────────────────────────────────────────────────────────
# CELL 15 — HYPOTHESIS TEST 1: TWO-SAMPLE t-TEST
#   H₀: Mean sale value is the same for Premium vs Standard products
#   H₁: Premium products have a higher mean sale value
# ──────────────────────────────────────────────────────────────
...
# ──────────────────────────────────────────────────────────────
# CELL 16 — HYPOTHESIS TEST 2: ONE-WAY ANOVA
#   H₀: Mean total sales is equal across all spirit types
#   H₁: At least one spirit type has a different mean
# ──────────────────────────────────────────────────────────────
...
# ──────────────────────────────────────────────────────────────
# CELL 17 — POST-HOC TEST: TUKEY HSD
# ──────────────────────────────────────────────────────────────
...
plot(tukey_result, las = 1, col = "steelblue",
     main = "Tukey HSD — 95% Family-Wise Confidence Intervals\n(pairs crossing zero = no significant difference)")
par(mar = c(5, 4, 4, 2))  # reset margins

cat("\n📌 Pairs whose confidence interval does NOT cross zero are significantly different.\n")


# ──────────────────────────────────────────────────────────────
# CELL 18 — HYPOTHESIS TEST 3: TWO-WAY ANOVA
#   Factors: spirit_type × is_premium
#   Do both factors AND their interaction affect total sales?
# ──────────────────────────────────────────────────────────────
...
# ──────────────────────────────────────────────────────────────
# CELL 19 — HYPOTHESIS TEST 4: CHI-SQUARE TEST
#   H₀: Spirit type is independent of bottle size category
#   H₁: There is an association between spirit type and size category
# ──────────────────────────────────────────────────────────────
...
# ──────────────────────────────────────────────────────────────
# CELL 20 — HYPOTHESIS TEST 5: KRUSKAL-WALLIS + DUNN POST-HOC
#   Non-parametric alternative to ANOVA for margin % by size category
# ──────────────────────────────────────────────────────────────
...
# ──────────────────────────────────────────────────────────────
# CELL 21 — HYPOTHESIS TEST 6: PEARSON CORRELATION
#   H₀: No linear correlation between bottle price and quantity sold
...
# ──────────────────────────────────────────────────────────────
# CELL 22 — REGRESSION: Multiple Linear Regression
#   Predict Total Sale Value from key drivers
# ──────────────────────────────────────────────────────────────
...
# ──────────────────────────────────────────────────────────────
# CELL 23 — REGRESSION DIAGNOSTICS
# ──────────────────────────────────────────────────────────────
...
# ──────────────────────────────────────────────────────────────
# CELL 24 — VARIABLE IMPORTANCE PLOT (from regression)
# ──────────────────────────────────────────────────────────────
...
# ──────────────────────────────────────────────────────────────
# CELL 25 — FINAL STORYTELLING SUMMARY DASHBOARD
# ──────────────────────────────────────────────────────────────
...
# ──────────────────────────────────────────────────────────────
# CELL 26 — STATISTICAL FINDINGS SUMMARY
# ──────────────────────────────────────────────────────────────
...
1. 📊 EDA KEY FINDINGS
   ▸ 2,000 valid transactions spanning 2014
   ▸ Total revenue driven by Polk County (38% share)
   ▸ Vodka is the #1 spirit by volume; Whiskey by revenue
   ▸ Avg gross margin ≈ 33% — Liqueurs command highest margins
   ▸ Strong right skew in sale values (skewness > 5)
   ▸ Q4 shows consistent revenue peaks (holiday effect)

2. ✅ HYPOTHESIS TEST RESULTS
   ▸ H1 (t-test)       : Premium products have SIGNIFICANTLY higher sales  (p<0.05)
   ▸ H2 (Welch ANOVA)  : Spirit type SIGNIFICANTLY affects sale value       (p<0.05)
   ▸ H3 (Two-way ANOVA): Both spirit type AND premium status are significant
                         with a potential interaction effect
   ▸ H4 (Chi-Square)   : Spirit type IS associated with bottle size category (p<0.001)
   ▸ H5 (Kruskal-Wallis): Margin % SIGNIFICANTLY differs by bottle size      (p<0.05)
   ▸ H6 (Correlation)  : Weak but significant correlation between price & qty

3. 📈 REGRESSION INSIGHTS
   ▸ Model explains ~XX% of variance in log(total sales)
   ▸ Bottle price & quantity are the strongest predictors
   ▸ Whiskey commands a significant premium over other categories
   ▸ Premium tier adds significant revenue per transaction

4. 💡 BUSINESS RECOMMENDATIONS
   ▸ Double down on Whiskey premiumisation — highest revenue driver
   ▸ Expand Polk County distribution footprint
   ▸ Run Q4 targeted campaigns for Liqueurs (high margin × seasonal demand)
   ▸ Renegotiate with lower-margin vendors (Diageo commands volume; check margins)
   ▸ Introduce 1-litre formats in Vodka — volume plays well in Standard tier
")
